...
public class AllParticipationAdapter extends RecyclerView.Adapter<AllParticipationAdapter.ViewHolder> {

    private static List<Participation> mListData;
    ...
    @NonNull
    @Override
    public AllParticipationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AllParticipationAdapter.ViewHolder(view,mListener);
    }

    @Override
    public void onBindViewHolder(@NonNull AllParticipationAdapter.ViewHolder holder, int position) {
    ...
    public AllParticipationAdapter(Context context, List<Participation> listData,onItemClickListener listener){
        mListData = listData;
        mContext = context;
        mListener = listener;
    }
